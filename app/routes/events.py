...
from app.schemas import EventsList, EventUpdate, LineEvent, EventRead
...
def update_line_by_id(event_id: int, data_for_update: EventUpdate, db_session: Session = Depends(get_session)):
